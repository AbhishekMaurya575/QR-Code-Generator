...
<main className="h-[84.5vh]">
    <section className="grid grid-cols-2 h-[85.5vh]">
     ...
     <button className="bg-purple-500 rounded-lg shadow-lg p-3 py-1 font-bold text-white">Try Now</button></NavLink>
      <NavLink to="/FindQRCode" className={({ isActive }) => (isActive ? 'text-red-500' : 'text-white')}>
       <button className="bg-purple-500 rounded-lg shadow-lg p-3 py-1 font-bold text-white">Find Now</button></NavLink>
       </div>
      </div>
